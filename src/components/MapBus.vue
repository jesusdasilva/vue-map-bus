...
import { GoogleMap, CustomMarker } from "vue3-google-map"; // Componentes para vue 3 de Google Maps, lo conseguí en internet
...
<template>
  ...
  <GoogleMap
    ...
    :zoom="15"
  >
    <!-- Componente que dibuja el marcador del Bus -->
    <CustomMarker :options="{ position: positionBus, anchorPoint: 'BOTTOM_CENTER' }">
        <!-- Aquí puedes poner el código HTML que quieras para el marcador -->
